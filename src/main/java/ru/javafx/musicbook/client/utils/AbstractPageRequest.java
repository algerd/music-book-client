...
public abstract class AbstractPageRequest {
	 ...
	 */
	public AbstractPageRequest previousOrFirst() {
	 ...
	 */
	public abstract AbstractPageRequest next();
	 ...
	 * @return
	 */
	public abstract AbstractPageRequest previous();

	/* 
	 * (non-Javadoc)
	 * @see org.springframework.data.domain.Pageable#first()
	 */
	public abstract AbstractPageRequest first();
